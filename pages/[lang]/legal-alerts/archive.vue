...
const articlesEndpoint = `/api/legal-alerts/-/${lang.value}`;
...
async function loadMore() {
	...
	const { data: newAlerts } = await useFetch<LocalizedLegalAlert[]>(endpoint);
		...
		<div class="container">
			...
			<div class="row gx-5">
				<div v-for="alert in alerts" class="bg-azul-1 mb-3 pb-4">
					<legal-alert :uuid="alert.uuid" :lang="lang" />
				</div>
			</div>
